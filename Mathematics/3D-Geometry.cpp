...
double scalarTripleProduct(point a,point b, point c){
...
// (or ray, or segment; in the case of the ray, the endpointis the first point)
...
double ptLineDist(double x1, double y1, double z1,double x2, double y2, double z2, double px, double py,double pz,int type) 
{
	return sqrt(ptLineDistSq(x1, y1, z1, x2, y2,z2, px, py, pz, type));
}
...
}//rotate point A about axis B-->C by theta. C should be unitvector along the axis
